...
from functions_etl.obtain_currency import append_to_data_price,obtain_currency
...
with DAG (
    ...
    [extract_task_API,extract_data_sells_directory,extract_data_purchases_directory] >> transform_data_update_stock >> transform_data_monetize_stock >> transform_data_monetize_stock